# D7 Tiled QKV：GUI 加波 + 录 VCD + run all
# 用法：Vivado Launch 仿真后，xsim Tcl Console：
#   restart
#   source F:/Users/22563/Desktop/FPGAlearn/requantize_int8_rtl/scripts/xsim/launch_tiled_qkv_with_vcd.tcl
# Sim Top 应为 tb_linear_tiled_qkv

set repo_root [file normalize [file join [file dirname [info script]] .. ..]]
set vcd_path [file join $repo_root tiled_qkv_full.vcd]

source [file normalize [file join [file dirname [info script]] gpt_tiled_qkv_wave_common.tcl]]
...
set TB_TOP [resolve_tiled_qkv_tb_top ""]
if { $TB_TOP eq "" || [llength [get_objects -quiet /${TB_TOP}/clk]] == 0 } {
  puts "ERROR: cannot detect tiled QKV testbench top."
  puts "  Expected: tb_linear_tiled_qkv"
  return
}
...
create_wave_config gpt_tiled_qkv_d7
...
set added [add_tiled_qkv_waves $TB_TOP]
if { $added == 0 } {
...
open_vcd $vcd_path
set logged [log_tiled_qkv_vcd $TB_TOP]
if { $logged == 0 } {
