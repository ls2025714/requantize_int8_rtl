# D4 Linear 层：GUI 加波 + 录 VCD + run all（一体脚本，无 bat）
...
# Sim Top 应为 tb_linear_int8_python_vectors

set repo_root [file normalize [file join [file dirname [info script]] .. ..]]
set vcd_path [file join $repo_root linear_int8_full.vcd]

source [file normalize [file join [file dirname [info script]] linear_int8_wave_common.tcl]]
...
set TB_TOP [resolve_linear_tb_top ""]
if { $TB_TOP eq "" || [llength [get_objects -quiet /${TB_TOP}/clk]] == 0 } {
  puts "ERROR: cannot detect linear INT8 testbench top."
  puts "  Expected: tb_linear_int8_python_vectors"
  return
}
...
create_wave_config linear_int8_d4
...
set added [add_linear_int8_waves $TB_TOP]
if { $added == 0 } {
...
open_vcd $vcd_path
set logged [log_linear_int8_vcd $TB_TOP]
if { $logged == 0 } {
