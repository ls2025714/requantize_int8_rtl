# D6 Tiled head0 Q：GUI 加波 + 录 VCD + run all
...
# Sim Top 应为 tb_linear_tiled_head0_q

set repo_root [file normalize [file join [file dirname [info script]] .. ..]]
set vcd_path [file join $repo_root tiled_head0_q_full.vcd]

source [file normalize [file join [file dirname [info script]] gpt_tiled_head0_q_wave_common.tcl]]
...
set TB_TOP [resolve_tiled_head0_q_tb_top ""]
if { $TB_TOP eq "" || [llength [get_objects -quiet /${TB_TOP}/clk]] == 0 } {
  puts "ERROR: cannot detect tiled head0 Q testbench top."
  puts "  Expected: tb_linear_tiled_head0_q"
  return
}
...
create_wave_config gpt_tiled_head0_q_d6
...
set added [add_tiled_head0_q_waves $TB_TOP]
if { $added == 0 } {
...
open_vcd $vcd_path
set logged [log_tiled_head0_q_vcd $TB_TOP]
if { $logged == 0 } {
