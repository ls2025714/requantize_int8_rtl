# 共享：D5 GPT Linear 层波形 / VCD 信号列表（由 launch_linear_int8_gpt_with_vcd.tcl source）

proc detect_gpt_linear_tb_top {} {
  foreach candidate {tb_linear_int8_gpt_vectors} {
...
proc log_gpt_linear_int8_vcd {tb_top} {
  set signal_list {
    clk rst_n
...
proc add_gpt_linear_int8_waves {tb_top} {
  set signal_list {
    clk rst_n
    cmd_valid cmd_ready cmd_m cmd_n cmd_k
    a_valid a_ready a_data
