@echo off
REM D4 regression: linear_int8 python vectors (after D6 weight_loader change)
REM Usage: scripts\run_linear_int8_xsim.bat
...
call xvlog --incr --relax -sv -work xil_defaultlib ^
  ...
  %SRC%/sim_1/new/tb_linear_int8_python_vectors.sv ^
  glbl.v -log xvlog_linear_d4.log
if errorlevel 1 exit /b 1

call xelab --incr --debug typical --relax --mt 2 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip ^
  --snapshot tb_linear_int8_python_vectors_behav ^
  xil_defaultlib.tb_linear_int8_python_vectors xil_defaultlib.glbl -log xelab_linear_d4.log
if errorlevel 1 exit /b 1

call xsim tb_linear_int8_python_vectors_behav -log simulate_linear_d4.log -R
exit /b %errorlevel%
