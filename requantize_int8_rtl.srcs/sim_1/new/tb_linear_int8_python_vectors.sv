...
module tb_linear_int8_python_vectors;
    ...
    localparam int EXPECTED_SEED       = 20260828;
    localparam string VECTOR_FILE      =
        "F:/Users/22563/Desktop/FPGAlearn/requantize_int8_rtl/linear_int8_vectors.txt";
    ...
    initial begin
        ...
        $display("Linear INT8 python-vector regression");
