...
// 学习阶段: D4 量化 — 组合逻辑参考版
// ----------------------------------------------------------------------------
// 【公式】out = saturate_sym( round(acc × scale) >>> SHIFT_BITS )，默认 shift=24
//   scale 为 18-bit 无符号；先扩成非负 signed 再乘；饱和到 [-127,127]
// 【对比】requantize_int8_pipeline：数学相同，2 拍流水（工程里 Linear/tiled 用流水版）
// 【验证】与 pipeline TB 对照
// ============================================================================
//
